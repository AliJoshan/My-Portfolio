...
import blogifyImg from "../assets/images/blogify.png";
...
const projects: Project[] = [
  ...
  },
  {
    title: "Blogify",
    description:
      "A modern full-stack blogging platform where users can create, edit, and manage posts with a rich text editor.",
    image: blogifyImg,
    tags: ["Next.js", "TypeScript", "Tailwind CSS", "Supabase", "TipTap"],
    liveUrl: "https://blogify-999.vercel.app/",
    githubUrl: "YOUR_GITHUB_REPO_URL",
    overview:
      "Blogify is a full-stack blogging platform built with Next.js and Supabase. Users can authenticate, create and edit blog posts with a rich text editor, and manage their own content through a clean and responsive interface.",
    features: [
      ...
      "Dynamic blog pages with routing",
    ],
    challenges:
      "Building a scalable editor experience with TipTap, handling authentication and database interactions with Supabase, and maintaining smooth loading states and responsive UI across the application.",
  },
];
  ...
  return (
    <section id="projects" className="py-28 section-gradient" ref={ref}>
      <div className="max-w-6xl mx-auto px-6">
        <h2
          className={`text-3xl sm:text-4xl font-bold text-center text-gray-100 mb-2 transition-all duration-700 ${
        ...
        <div
          className={`w-16 h-1 bg-[hsl(199,89%,58%)] mx-auto mb-16 rounded-full transition-all duration-700 delay-100 ${
